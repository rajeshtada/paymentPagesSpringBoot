...
public class IDBINBBankUtils {
	public static final String IDBI_NB_URL_KEY = "IDBI_NB_URL_KEY";
	public static final String IDBI_NB_RETURN_URL = "IDBI_NB_RETURN_URL";
	public static final String IDBI_NB_CATEGORY_ID = "IDBI_NB_CATEGORY_ID";
	public static final String IDBI_NB_PID = "IDBI_NB_PID";

	public static final String IDBI_NB_SECRET_KEY = "IDBI_NB_SECRET_KEY";
	public static final String IDBI_NB_SALT = "IDBI_NB_SALT";
	public static final String IDBI_NB_ENCRYPTION_KEY = "IDBI_NB_ENCRYPTION_KEY";
