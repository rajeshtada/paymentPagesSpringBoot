...
@Table(name = "settlement_report_history_rts")
@Entity
public class SettlementReportHistoryRTS implements Serializable{
	...
	public String toString() {
		return "SettlementReportHistoryRTS [id=" + id + ", requestId=" + requestId + ", chargesId=" + chargesId
				+ ", settlementHistoryId=" + settlementHistoryId + ", status=" + status + ", rrn=" + rrn
				+ ", merchantSettlementRefNo=" + merchantSettlementRefNo + ", mid=" + mid + ", vpa=" + vpa
				+ ", createdDate=" + createdDate + ", modifiedDate=" + modifiedDate + ", remark=" + remark + ", amt="
				+ amt + "]";
	}
