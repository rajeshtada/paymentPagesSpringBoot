...
@Entity
@Audited
@Table(name = "setting_commision")
public class MerchantCommision2 implements Serializable {
	...
	public String toString() {
		return "MerchantCommision2 [id=" + id + ", defaultSettingId=" + defaultSettingId + ", commisionType="
				+ commisionType + ", commisionvalue=" + commisionvalue + ", isDefault=" + isDefault + ", chargeType="
				+ chargeType + ", paymentMode=" + paymentMode + ", productType=" + productType + ", subType=" + subType
