...
@Entity
@Audited
@Table(name = "merchant_netbanking_routing")
public class MerchantNetBankingRouting implements Serializable {
	...
	@Column(name = "NetBankingRouting_id")
	private Long id;
	...
	public String toString() {
		return "MerchantNetBankingRouting [id=" + id + ", mid=" + mid + ", currency=" + currency + ", setting1="
