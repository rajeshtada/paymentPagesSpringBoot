...
@Entity
@Audited
@Table(name = "setting_our_pmc")
public class MerchantProducts2 implements Serializable {
	...
	public String toString() {
		return "MerchantProducts2 [id=" + id + ", enabledCurrencies=" + enabledCurrencies + ", enabledPaymentModes="
				+ enabledPaymentModes + ", productType=" + productType + ", terminalId=" + terminalId + ", posId="
				+ posId + ", defaultProcessor=" + defaultProcessor + ", defaultSettingId=" + defaultSettingId + "]";
	}
