...
public class MerchantCallBackPushApiRequest {
	...
	public String toString() {
		return "MerchantCallBackPushApiRequest [BankId=" + BankId + ", MerchantId=" + MerchantId + ", TerminalId="
				...
				+ ", PaymentOption=" + PaymentOption + ", IpAddress=" + IpAddress + ", BrowserDetails=" + BrowserDetails
				+ ", AcceptHeader=" + AcceptHeader + ", UserAgent=" + UserAgent + ", CardNumber=" + CardNumber
				+ ", ExpiryDate=" + ExpiryDate + ", CVV=" + CVV + ", AuthenticationResponseURL="
				+ AuthenticationResponseURL + ", chFirstName=" + chFirstName + ", chLastName=" + chLastName
				...
				+ ", UDF07=" + UDF07 + ", UDF08=" + UDF08 + ", UDF09=" + UDF09 + ", UDF10=" + UDF10
				+ ", MaskedCardNumber=" + MaskedCardNumber + ", ResponseCode=" + ResponseCode + ", ResponseMessage="
				+ ResponseMessage + ", RetRefNo=" + RetRefNo + ", ApprovalCode=" + ApprovalCode + ", SecureHash="
				+ SecureHash + "]";
	}
