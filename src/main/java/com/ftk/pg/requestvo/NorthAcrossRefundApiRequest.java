...
public class NorthAcrossRefundApiRequest {
	 private String api_key;
		...
		public String toString() {
			return "IDFCRefundApiRequest [api_key=" + api_key + ", transaction_id=" + transaction_id
					+ ", merchant_refund_id=" + merchant_refund_id + ", amount=" + amount + ", description="
