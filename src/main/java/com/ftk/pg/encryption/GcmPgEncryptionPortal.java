...
public class GcmPgEncryptionPortal {
...
//	private static final String masterKey = "bVpxNHQ3dyF6JUMqRi1KYU5kUmdVa1hwMnI1dTh4L0E=";
	...
	public GcmPgEncryptionPortal() {
		
	}

	public GcmPgEncryptionPortal(String iv, String key) throws Exception {
		this.iv = iv;
		this.ivKey = key;
	...
	public String decryptWithMKeys(String cipherContent) throws Exception {
		...
		Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM);
		SecretKey aesKeyFromPassword = getAESKeyFromPassword(this.mKey.toCharArray(), salt);
	...
	public String encryptWithMKeys(String plainMessage) throws Exception {
		...
		SecretKey secretKey = getSecretKey(this.mKey, salt);
