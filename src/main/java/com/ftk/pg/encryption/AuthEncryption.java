...
import com.ftk.pg.util.Hex;

//import com.atom.ots.enc.AtomEncryption;

public class AuthEncryption {
	 static Logger logger = LogManager.getLogger(AuthEncryption.class);
	public static final String PAYMETZ_NEW_ENC_KEY="A4476C2062FFA58980DC8F79EB6A799E";
	public static final String PAYNETZ_NEW_DEC_KEY="75AEF0FA1B94B3C10D4F5B268F757F11";
	...
	public static String getAuthDecrypted(String encData, String key) {
		...
		try {
			...
			logger.error(": EXCEPTION IN DECRYPTION ::" + e.getMessage());
		}
		return decrypted;
	}
	...
	public static String getAuthEncrypted(String plainData, String key) {
		...
		try {
			...
			logger.error(": EXCEPTION IN ENCRYPTION ::" + e.getMessage());
		}
		return encrypted;
	}
	...
	public String decrypt(String salt, String iv, String ciphertext) {
		try {
			...
			logger.error(": EXCEPTION IN DECODING ::" + e.getMessage());
			throw fail(e);
		}
	}
	...
	private byte[] doFinal(int encryptMode, SecretKey key, String iv, byte[] bytes) {
		try {
			...
			logger.error(": EXCEPTION IN ENC/DEC ::" + e.getMessage());
			throw fail(e);
		}
	}
	...
	private static SecretKey generateKey(String salt, String passphrase) throws NoSuchAlgorithmException {
		try {
			...
			logger.error(": EXCEPTION IN GENERATION OF ENC/DEC KEY ::" + e.getMessage());
			throw fail(e);
		}
	}
