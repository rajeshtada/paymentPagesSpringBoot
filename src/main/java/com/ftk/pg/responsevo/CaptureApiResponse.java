...
public class CaptureApiResponse {
	...
	public String toString() {
		return "CaptureApiResponse [BankId=" + BankId + ", MerchantId=" + MerchantId + ", TerminalId=" + TerminalId
				+ ", OrderId=" + OrderId + ", AccessCode=" + AccessCode + ", CaptureAmount=" + CaptureAmount + ", PgId="
				+ PgId + ", ResponseCode=" + ResponseCode + ", ResponseMessage=" + ResponseMessage + ", RetRefNo="
				+ RetRefNo + ", RefCancellationId=" + RefCancellationId + ", SecureHash=" + SecureHash + "]";
	}
