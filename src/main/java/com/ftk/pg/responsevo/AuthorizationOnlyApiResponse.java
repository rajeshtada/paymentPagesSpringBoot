...
public class AuthorizationOnlyApiResponse {
	...
	private String AuthenticationCAVV;

	private String Authentication3dDSVersion;
	...
	public String getAuthenticationECI() {
		return AuthenticationECI;
	}

	public void setAuthenticationECI(String authenticationECI) {
	...
	public void setAuthenticationCAVV(String authenticationCAVV) {
		AuthenticationCAVV = authenticationCAVV;
	}

	public String getAuthentication3dDSVersion() {
		return Authentication3dDSVersion;
	}

	public void setAuthentication3dDSVersion(String authentication3dDSVersion) {
		Authentication3dDSVersion = authentication3dDSVersion;
	}
	...
	public String getCardTokenResponseCode() {
		return CardTokenResponseCode;
	}

	public void setCardTokenResponseCode(String cardTokenResponseCode) {
		CardTokenResponseCode = cardTokenResponseCode;
	}

	public String getCardTokenResponseMessage() {
		return CardTokenResponseMessage;
	}

	public void setCardTokenResponseMessage(String cardTokenResponseMessage) {
	...
	public String toString() {
		return "AuthorizationOnlyApiResponse [BankId=" + BankId + ", MerchantId=" + MerchantId + ", TerminalId="
				+ TerminalId + ", OrderId=" + OrderId + ", MCC=" + MCC + ", AccessCode=" + AccessCode + ", Command="
				+ Command + ", Currency=" + Currency + ", Amount=" + Amount + ", OrderInfo=" + OrderInfo
				+ ", PaymentOption=" + PaymentOption + ", IpAddress=" + IpAddress + ", CardNumber=" + CardNumber
				+ ", ExpiryDate=" + ExpiryDate + ", CVV=" + CVV + ", AuthenticationECI=" + AuthenticationECI
				+ ", AuthenticationCAVV=" + AuthenticationCAVV + ", Authentication3dDSVersion="
				+ Authentication3dDSVersion + ", chFirstName=" + chFirstName + ", chLastName=" + chLastName
				+ ", chAddrStreet=" + chAddrStreet + ", chAddrCity=" + chAddrCity + ", chAddrState=" + chAddrState
				+ ", chAddrZip=" + chAddrZip + ", chEmail=" + chEmail + ", chPhone=" + chPhone + ", UDF01=" + UDF01
				+ ", UDF02=" + UDF02 + ", UDF03=" + UDF03 + ", UDF04=" + UDF04 + ", UDF05=" + UDF05 + ", UDF06=" + UDF06
				+ ", UDF07=" + UDF07 + ", UDF08=" + UDF08 + ", UDF09=" + UDF09 + ", UDF10=" + UDF10 + ", CustomerId="
				+ CustomerId + ", SiType=" + SiType + ", SiTxnType=" + SiTxnType + ", SiStartDate=" + SiStartDate
				+ ", SiEndDate=" + SiEndDate + ", PaymentFrequency=" + PaymentFrequency + ", SiAmount=" + SiAmount
				+ ", SiMaxAmount=" + SiMaxAmount + ", SiMaxTxnCount=" + SiMaxTxnCount + ", SiPGRegID=" + SiPGRegID
				+ ", ResponseCode=" + ResponseCode + ", ResponseMessage=" + ResponseMessage + ", RetRefNo=" + RetRefNo
				+ ", ApprovalCode=" + ApprovalCode + ", chUserID=" + chUserID + ", CardTokenReferenceNo="
				+ CardTokenReferenceNo + ", CardTokenResponseCode=" + CardTokenResponseCode
				+ ", CardTokenResponseMessage=" + CardTokenResponseMessage + ", SecureHash=" + SecureHash + "]";
	}
